...
#[cfg_attr(feature = "display", derive(strum::Display, strum::EnumIter))]
pub enum PipelineProcessingRate {
    /// Limit the rate to 32k Hz.
    #[cfg_attr(feature = "display", strum(serialize = "32 kHz"))]
    Max32000Hz = 32_000,

    /// Limit the rate to 48k Hz.
    #[default]
    #[cfg_attr(feature = "display", strum(serialize = "48 kHz"))]
    Max48000Hz = 48_000,
}
...
pub enum DownmixMethod {
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Use first channel"))]
    UseFirstChannel,
}
...
pub enum CaptureAmplifier {
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Pre-amplifier"))]
    PreAmplifier(PreAmplifier),
    /// Use the new CaptureLevelAdjustment.
    #[cfg_attr(feature = "display", strum(serialize = "Capture level adjustment"))]
...
pub enum EchoCanceller {
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Mobile (AECM)"))]
    Mobile {
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Full (AEC3)"))]
    Full {
        /// Set the delay in ms between process_render_frame() and process_capture_frame().
...
pub enum NoiseSuppressionLevel {
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Very High"))]
    VeryHigh,
}
...
pub enum GainController {
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Gain Controller 1"))]
    GainController1(GainController1),
    /// New gain controller 2.
    #[cfg_attr(feature = "display", strum(serialize = "Gain Controller 2"))]
...
pub enum GainControllerMode {
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Adaptive Analog"))]
    AdaptiveAnalog,
    ...
    /// compression stage.
    #[cfg_attr(feature = "display", strum(serialize = "Adaptive Digital"))]
    AdaptiveDigital,
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Fixed Digital"))]
    FixedDigital,
}
...
pub enum ClippingPredictorMode {
    ...
    #[cfg_attr(feature = "display", strum(serialize = "Clipping Event Prediction"))]
    ClippingEventPrediction,
    /// Clipped peak estimation mode with adaptive step estimation.
    #[cfg_attr(feature = "display", strum(serialize = "Adaptive Step Clipping Peak Prediction"))]
    AdaptiveStepClippingPeakPrediction,
    /// Clipped peak estimation mode with fixed step estimation.
    #[cfg_attr(feature = "display", strum(serialize = "Fixed Step Clipping Peak Prediction"))]
