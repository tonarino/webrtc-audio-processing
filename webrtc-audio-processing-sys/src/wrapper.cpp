...
build_aec3_config(const EchoCanceller3ConfigOverride &override) {
  ...
  config.delay.fixed_capture_delay_samples =
      override.delay_fixed_capture_delay_samples;
  config.delay.delay_estimate_smoothing = override.delay_estimate_smoothing;
  config.delay.delay_estimate_smoothing_delay_found =
      override.delay_estimate_smoothing_delay_found;
  config.delay.delay_candidate_detection_threshold =
      override.delay_candidate_detection_threshold;
  config.delay.delay_selection_thresholds.initial =
      override.delay_selection_thresholds_initial;
  config.delay.delay_selection_thresholds.converged =
      override.delay_selection_thresholds_converged;
  config.delay.use_external_delay_estimator =
      override.delay_use_external_delay_estimator;
  config.delay.log_warning_on_delay_changes =
      override.delay_log_warning_on_delay_changes;
  ...
  config.delay.render_alignment_mixing.downmix =
      override.delay_render_alignment_mixing_downmix;
  ...
  config.delay.capture_alignment_mixing.downmix =
      override.delay_capture_alignment_mixing_downmix;
  ...
  config.filter.refined.leakage_converged =
      override.filter_refined_leakage_converged;
  config.filter.refined.leakage_diverged =
      override.filter_refined_leakage_diverged;
  ...
  config.erle.clamp_quality_estimate_to_zero =
      override.erle_clamp_quality_estimate_to_zero;
  config.erle.clamp_quality_estimate_to_one =
      override.erle_clamp_quality_estimate_to_one;
  ...
  config.echo_audibility.low_render_limit =
      override.echo_audibility_low_render_limit;
  config.echo_audibility.normal_render_limit =
      override.echo_audibility_normal_render_limit;
  config.echo_audibility.floor_power = override.echo_audibility_floor_power;
  config.echo_audibility.audibility_threshold_lf =
      override.echo_audibility_audibility_threshold_lf;
  config.echo_audibility.audibility_threshold_mf =
      override.echo_audibility_audibility_threshold_mf;
  config.echo_audibility.audibility_threshold_hf =
      override.echo_audibility_audibility_threshold_hf;
  config.echo_audibility.use_stationarity_properties =
      override.echo_audibility_use_stationarity_properties;
  ...
  config.render_levels.active_render_limit =
      override.render_levels_active_render_limit;
  config.render_levels.poor_excitation_render_limit =
      override.render_levels_poor_excitation_render_limit;
  config.render_levels.poor_excitation_render_limit_ds8 =
      override.render_levels_poor_excitation_render_limit_ds8;
  config.render_levels.render_power_gain_db =
      override.render_levels_render_power_gain_db;

  // EchoRemovalControl
  config.echo_removal_control.has_clock_drift =
      override.echo_removal_control_has_clock_drift;
  ...
  config.echo_model.min_noise_floor_power =
      override.echo_model_min_noise_floor_power;
  config.echo_model.stationary_gate_slope =
      override.echo_model_stationary_gate_slope;
  ...
  config.echo_model.render_pre_window_size =
      override.echo_model_render_pre_window_size;
  config.echo_model.render_post_window_size =
      override.echo_model_render_post_window_size;
  config.echo_model.model_reverb_in_nonlinear_mode =
      override.echo_model_model_reverb_in_nonlinear_mode;

  // ComfortNoise
  config.comfort_noise.noise_floor_dbfs =
      override.comfort_noise_noise_floor_dbfs;

  // Suppressor
  config.suppressor.nearend_average_blocks =
      override.suppressor_nearend_average_blocks;
  ...
  config.suppressor.floor_first_increase =
      override.suppressor_floor_first_increase;
  ...
  config.suppressor.last_lf_smoothing_band =
      override.suppressor_last_lf_smoothing_band;
  ...
  config.suppressor.dominant_nearend_detection.use_unbounded_echo_spectrum =
      override
          .suppressor_dominant_nearend_detection_use_unbounded_echo_spectrum;
  ...
  config.suppressor.high_bands_suppression.anti_howling_activation_threshold =
      override
          .suppressor_high_bands_suppression_anti_howling_activation_threshold;
  ...
  config.suppressor.conservative_hf_suppression =
      override.suppressor_conservative_hf_suppression;

  // MultiChannel
  config.multi_channel.detect_stereo_content =
      override.multi_channel_detect_stereo_content;
...
AudioProcessing *audio_processing_create(
  ...
  if (aec3_config_override != nullptr) {
    webrtc::EchoCanceller3Config config =
        build_aec3_config(*aec3_config_override);
...
extern "C" bool webrtc_Aec3Config_Validate(
    const webrtc_audio_processing_wrapper::EchoCanceller3ConfigOverride
        *config_override) {
  webrtc::EchoCanceller3Config config =
      webrtc_audio_processing_wrapper::build_aec3_config(*config_override);
