...
AudioProcessing* audio_processing_create(
    ...
    if (aec3_config_override != nullptr) {
        webrtc::EchoCanceller3Config config = build_aec3_config(*aec3_config_override);
...
extern "C" bool webrtc_Aec3Config_Validate(const webrtc_audio_processing_wrapper::EchoCanceller3ConfigOverride* config_override) {
    webrtc::EchoCanceller3Config config = webrtc_audio_processing_wrapper::build_aec3_config(*config_override);
